...
def parse_args():
    ...
    parser.add_argument('--predict', '-pred', action='store_true',
                        help='load the trained models from checkpoints and predict on new dataset')
    ...
    parser.add_argument('--eval_batch', '-eb', type=int, default=52000,
    ...
    parser.add_argument('--list_size', '-ls', type=int, default=10,
                        help='list size for ranking')
    parser.add_argument('--max_iter', '-mi', type=int, default=5,
    ...
    parser.add_argument('--augment', '-a', nargs='*', type=str, default="GEMME",
    ...
    parser.add_argument('--meta_train_batch', '-mtb', type=int, default=16,
                        help='inner batch size for meta training')
    parser.add_argument('--meta_eval_batch', '-meb', type=int, default=128,
    ...
    parser.add_argument('--adapt_steps', '-as', type=int, default=5,
